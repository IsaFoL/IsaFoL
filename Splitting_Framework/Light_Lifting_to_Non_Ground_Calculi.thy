...
theory Light_Lifting_to_Non_Ground_Calculi
  imports
    Saturation_Framework.Intersection_Calculus
    Saturation_Framework.Calculus_Variations
...
locale light_standard_lifting = inference_system Inf_F +
...
locale light_strong_standard_lifting = inference_system Inf_F +
  ground: calculus Bot_G Inf_G entails_G Red_I_G Red_F_G
  for
    Inf_F :: \<open>'f inference set\<close> and
    Bot_G :: \<open>'g set\<close> and
...
sublocale light_standard_lifting Inf_F Bot_G Inf_G "(\<Turnstile>G)" Red_I_G Red_F_G Bot_F \<G>_F \<G>_I
proof
  show "Bot_F \<noteq> {}" using Bot_F_not_empty .
next
  fix B
...
locale light_tiebreaker_lifting =
  empty_ord?: light_standard_lifting Inf_F Bot_G Inf_G entails_G Red_I_G Red_F_G Bot_F \<G>_F \<G>_I
  for
    Bot_F :: \<open>'f set\<close> and
    Inf_F :: \<open>'f inference set\<close> and
    Bot_G :: \<open>'g set\<close> and
...
lemma light_standard_empty_tiebreaker_equiv: "light_standard_lifting Inf_F Bot_G Inf_G entails_G Red_I_G
  Red_F_G Bot_F \<G>_F \<G>_I = light_tiebreaker_lifting Bot_F Inf_F Bot_G entails_G Inf_G Red_I_G
  Red_F_G \<G>_F \<G>_I (\<lambda>g C C'. False)"
proof -
  have "light_tiebreaker_lifting_axioms (\<lambda>g C C'. False)"
    unfolding light_tiebreaker_lifting_axioms_def using wf_empty_rel by simp
  then show ?thesis
    unfolding light_standard_lifting_def light_tiebreaker_lifting_def by blast
qed

context light_standard_lifting
begin

  interpretation empt_ord: light_tiebreaker_lifting Bot_F Inf_F Bot_G entails_G Inf_G Red_I_G
    Red_F_G \<G>_F \<G>_I "\<lambda>g C C'. False"
    using light_standard_empty_tiebreaker_equiv using light_standard_lifting_axioms by blast
...
context light_tiebreaker_lifting
begin
...
locale light_lifting_intersection = inference_system Inf_F +
  ...
  assumes
    light_standard_lifting_family:
      "\<forall>q \<in> Q. light_tiebreaker_lifting Bot_F Inf_F Bot_G (entails_q q) (Inf_G_q q) (Red_I_q q)
...
proof -
  interpret wf_lift:
    light_tiebreaker_lifting Bot_F Inf_F Bot_G "entails_q q" "Inf_G_q q" "Red_I_q q"
      "Red_F_q q" "\<G>_F_q q" "\<G>_I_q q" Prec_F_g
    using light_standard_lifting_family q_in by metis
...
next
  ...
  interpret lift: light_tiebreaker_lifting Bot_F Inf_F Bot_G "entails_q qi" "Inf_G_q qi"
    "Red_I_q qi" "Red_F_q qi" "\<G>_F_q qi" "\<G>_I_q qi" Prec_F_g
    using qi_in by (metis light_standard_lifting_family)
