...
context begin
private lemma dt: "F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> G"
  by (metis AX100 Deduction_theorem Un_insert_right sup_left_commute)
lemma sim: "\<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<Longrightarrow> F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G"
  using MP dt by blast
lemma sim_conj: "F \<cdot> G \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H H \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H H"
  using MP dt by (metis Un_insert_left)
lemma sim_disj: "\<lbrakk>F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H H; G \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H H; \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<or> G\<rbrakk> \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H H"
proof goal_cases
  case 1
...
proof -
  have "F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> F \<^bold>\<rightarrow> F \<^bold>\<rightarrow> \<bottom>"
    by (meson HC_intros(12) HC_mono subset_insertI sup_ge2)
  then have "\<^bold>\<not> F \<cdot> F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>"
...
proof -
  ...
  have "F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H ( \<^bold>\<not> F \<^bold>\<or> F)"
    by (metis AX10.intros(3) Ax HC_mono MP Un_commute Un_insert_left insertI1 sup_ge1)
  hence "F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<^bold>\<rightarrow> \<bottom>" using someax by (metis HC.simps Un_insert_left)
  hence "\<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<cdot> F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>" by (meson Ax HC_mono MP insertI1 subset_insertI)
  hence "\<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> \<bottom>"
    by (metis Un_insert_left dt insert_commute)
      
  have "\<^bold>\<not>F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H ( \<^bold>\<not> F \<^bold>\<or> F)"
    by (metis HC.simps HC_intros(5) HC_mono inf_sup_ord(4) insertI1 insert_is_Un)
  hence "\<^bold>\<not>F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<^bold>\<rightarrow> \<bottom>" using someax by (metis HC.simps Un_insert_left)
  hence "\<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<cdot> \<^bold>\<not>F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>" by (meson Ax HC_mono MP insertI1 subset_insertI)
  hence "\<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not>F \<^bold>\<rightarrow> \<bottom>"
    by (metis Un_insert_left dt insert_commute)
  
  hence "\<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> ( \<^bold>\<not> F \<^bold>\<or> F) \<^bold>\<rightarrow> \<bottom>"
    by (meson HC_intros(13) HC_mono MP \<open>\<^bold>\<not> (\<^bold>\<not> F \<^bold>\<or> F) \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> \<bottom>\<close> dt subset_insertI sup_ge2)
...
proof goal_cases case 1
  ...
  proof -
    have f1: "\<forall>F f Fa. \<not> (F \<turnstile>\<^sub>H f) \<or> \<not> F \<subseteq> Fa \<or> Fa \<turnstile>\<^sub>H f"
      using HC_mono by satx
    then have f2: "F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> G"
      by (metis "1" subset_insertI) (* > 1.0 s, timed out *)
    have "\<Gamma> \<union> AX10 \<turnstile>\<^sub>H G \<^bold>\<rightarrow> \<^bold>\<not> F \<^bold>\<or> G"
      using f1 by (meson AX10.intros(3) Ax sup.cobounded2)
    then show ?thesis
  ...
  proof -
    have "\<And>F f fa fb. \<not> (F \<turnstile>\<^sub>H f \<^bold>\<rightarrow> fa) \<or> \<not> (fb \<cdot> F \<turnstile>\<^sub>H f) \<or> fb \<cdot> F \<turnstile>\<^sub>H fa"
      by (meson HC_mono MP subset_insertI)
    then show ?thesis
      by (meson Ax \<open>\<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> \<^bold>\<not> F \<^bold>\<or> G\<close> \<open>\<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> F \<^bold>\<rightarrow> \<^bold>\<not> F \<^bold>\<or> G\<close> insertI1 lem sim_disj)
  qed
qed
...
lemma HC_case_distinction: "\<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<rightarrow> G \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> F \<^bold>\<rightarrow> G \<Longrightarrow> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G"
  using HC_intros(7)[of F G "Not F"] lem2 by (meson HC_mono MP sup_ge2)
...
proof goal_cases case 1
  ...
  hence 2: "F \<cdot> G \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H F \<^bold>\<and> G"
    by (meson Ax HC_mono MP insertI1 subset_insertI)
  hence 3: "F \<cdot> G \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>" using 1 by (meson HC_intros(12) HC_mono MP subset_insertI sup_ge2)
...
shows "\<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> F" " \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<^bold>\<not> G"
  using HC_contrapos_nn assms by (meson HC_intros(5,6) HC_mono MP sup_ge2)+
...
proof goal_cases case 1
  ...
  hence "\<^bold>\<not> F \<cdot> F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>" by (meson HC.simps HC_mono insertI1 subset_insertI)
  hence "\<^bold>\<not> F \<cdot> F \<cdot> \<Gamma> \<union> AX10 \<turnstile>\<^sub>H G" by (metis Un_commute Un_insert_right inpcp)
...
lemma HC_consistent:  "pcp {\<Gamma>| \<Gamma>. \<not>(\<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>)}"
  ...
  subgoal using sim_conj by (meson Ax HC_intros(8) HC_intros(9) HC_mono MP sup_ge1 sup_ge2)
  subgoal using sim_disj using Ax by auto
  subgoal by (erule (1) sim_disj) (simp add: Ax imp_sim)
  subgoal by (metis Ax HC_intros(12) HC_intros(13) HC_mono MP sim sup_ge1 sup_ge2)  
...
corollary HC_complete: "\<Turnstile> F \<Longrightarrow> AX10 \<turnstile>\<^sub>H F"
proof(erule contrapos_pp)
  let ?W = "{\<Gamma>| \<Gamma>. \<not>(\<Gamma> \<union> AX10 \<turnstile>\<^sub>H \<bottom>)}"
  assume \<open>\<not> (AX10 \<turnstile>\<^sub>H F)\<close>
  hence "\<not> (\<^bold>\<not>F \<cdot> AX10 \<turnstile>\<^sub>H \<bottom>)"
