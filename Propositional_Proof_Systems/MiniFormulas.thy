...
text\<open>
  ...
  The main focus of ~\cite{johansson1937minimal} is on removing rules from Calculi anyway, not on removing connectives.\<close>
...
lemma mini_to_mini: "is_mini_formula F \<Longrightarrow> to_mini_formula F = F"
  by(induction F; simp)
corollary mini_mini: "to_mini_formula (to_mini_formula F) = to_mini_formula F"
