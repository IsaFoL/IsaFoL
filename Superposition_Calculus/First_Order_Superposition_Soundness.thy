...
proof (cases P2 P1 C rule: superposition.cases)
  ...
  proof -
    ...
    assume 
     ...
     have wt_P: "welltyped\<^sub>c typeof_fun \<V>\<^sub>1 P\<^sub>1" "welltyped\<^sub>c typeof_fun \<V>\<^sub>2 P\<^sub>2"
     ...
     have 
       "\<And>\<sigma>. welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>3 \<sigma> \<Longrightarrow> welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>1 (\<rho>\<^sub>1 \<odot> \<sigma>)"
       "\<And>\<sigma>. welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>3 \<sigma> \<Longrightarrow> welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>2 (\<rho>\<^sub>2 \<odot> \<sigma>)"
       using superpositionI(15-18) superpositionI(4-5)
       unfolding welltyped\<^sub>\<sigma>_def
      
       sorry

     then have wt_\<gamma>: "welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>1 (\<rho>\<^sub>1 \<odot> \<mu> \<odot> \<gamma>)" "welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>2 (\<rho>\<^sub>2 \<odot> \<mu> \<odot> \<gamma>)"
       using superpositionI(14-18) 
       unfolding welltyped\<^sub>\<sigma>_def
       by (metis (no_types, lifting) grounding(3) subst_compose_assoc subst_compose_def welltyped\<^sub>\<sigma>_welltyped)+

     have "?I \<TTurnstile> ?P\<^sub>1"
       using premise1[rule_format, of ?P\<^sub>1, OF exI, of "\<rho>\<^sub>1 \<odot> \<mu> \<odot> \<gamma>"] ground_subst wt_P  wt_\<gamma>
       by auto

     moreover have "?I \<TTurnstile> ?P\<^sub>2"
       using premise2[rule_format, of ?P\<^sub>2, OF exI, of "\<rho>\<^sub>2 \<odot> \<mu> \<odot> \<gamma>"]  ground_subst wt_P  wt_\<gamma>
       by auto
