...
lemma superposition_lifting:
  ...
  assumes 
    ...
    typing:
      ...
      "term_subst.is_ground_subst \<gamma>"
      "welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>1 (\<rho>\<^sub>1 \<odot> \<gamma>)"
      "welltyped\<^sub>\<sigma> typeof_fun \<V>\<^sub>2 (\<rho>\<^sub>2 \<odot> \<gamma>)"
