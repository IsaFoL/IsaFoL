...
proof -
  ...
  next
    ...
    hence "negs (mset Ai) \<subseteq># DA"
  ...
  hence "\<And>B A. A\<in>set Ai \<Longrightarrow> B \<in># CA_of A \<Longrightarrow> B \<noteq> Pos A \<Longrightarrow> atm_of B < A"
