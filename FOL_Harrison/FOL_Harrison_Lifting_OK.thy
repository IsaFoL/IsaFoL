(*
  FOL-Harrison - Verification of an LCF-Style First-Order Prover with Equality. Lifting proof system predicate to a type of theorems.
...
typedef "thm" = "{p :: fol fm. \<turnstile> p}"
proof -
  have "\<turnstile> axiom_addimp_fm Truth Truth"
...
theorem soundness: "semantics e f g (concl p)"
  using soundness_fm Rep_thm by fastforce 
