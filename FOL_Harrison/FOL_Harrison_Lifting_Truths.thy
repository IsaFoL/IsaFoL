(*
  FOL-Harrison - Verification of an LCF-Style First-Order Prover with Equality. Lifting the truths to a type of theorems.
...
theory FOL_Harrison_Lifting_Truths
imports Main
begin
...
proof -
  have "\<forall>(e :: id \<Rightarrow> U) f g. semantics e f g Truth"
    by auto
...
lift_definition gen :: "id \<Rightarrow> thm \<Rightarrow> thm" is gen_fm
  unfolding gen_fm_def
  by auto
    
lift_definition axiom_addimp :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_addimp_fm
  unfolding axiom_addimp_fm_def
  by auto

lift_definition axiom_distribimp :: "fol fm \<Rightarrow> fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is "axiom_distribimp_fm"
  unfolding axiom_distribimp_fm_def
  by auto
  
lift_definition axiom_doubleneg :: "fol fm \<Rightarrow> thm" is axiom_doubleneg_fm
  unfolding axiom_doubleneg_fm_def
  by auto
    
lift_definition axiom_allimp :: "id \<Rightarrow> fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_allimp_fm
  unfolding axiom_allimp_fm_def
  by auto
    
lift_definition axiom_impall :: "id \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_impall_fm
  unfolding axiom_impall_fm_def
  using map
  by simp iprover
    
lift_definition axiom_existseq :: "id \<Rightarrow> tm \<Rightarrow> thm" is axiom_existseq_fm
  unfolding axiom_existseq_fm_def fol_equal_def
  using map'(1) length2_def
  by simp iprover
    
lift_definition axiom_eqrefl :: "tm \<Rightarrow> thm" is axiom_eqrefl_fm
  unfolding axiom_eqrefl_fm_def fol_equal_def
  using length2_def
  by simp
    
lift_definition axiom_funcong :: "id \<Rightarrow> tm list \<Rightarrow> tm list \<Rightarrow> thm" is axiom_funcong_fm
  unfolding axiom_funcong_fm_def
  using funcong
  by simp standard

lift_definition axiom_predcong :: "id \<Rightarrow> tm list \<Rightarrow> tm list \<Rightarrow> thm" is "axiom_predcong_fm"
  unfolding axiom_predcong_fm_def
  using predcong
  by simp standard
    
lift_definition axiom_iffimp1 :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_iffimp1_fm
  unfolding axiom_iffimp1_fm_def 
  by auto
    
lift_definition axiom_iffimp2 :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_iffimp2_fm
  unfolding axiom_iffimp2_fm_def
  by auto
  
lift_definition axiom_impiff :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_impiff_fm
  unfolding axiom_impiff_fm_def
  by auto

lift_definition axiom_true :: "thm" is axiom_true_fm
  unfolding axiom_true_fm_def
  by auto
  
lift_definition axiom_not :: "fol fm \<Rightarrow> thm" is axiom_not_fm
  unfolding axiom_not_fm_def
  by auto

lift_definition axiom_and :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_and_fm
  unfolding axiom_and_fm_def
  by auto

lift_definition axiom_or :: "fol fm \<Rightarrow> fol fm \<Rightarrow> thm" is axiom_or_fm
...
(* Example. Doesn't make much sense anymore, I guess... *)
(*
...
lemma consistency: "concl p \<noteq> Falsity"
proof 
  assume "concl p = Falsity"
  then have "\<forall>(e :: id \<Rightarrow> U) f g. semantics e f g Falsity"
    using Rep_thm unfolding concl_def by (metis (no_types, lifting) mem_Collect_eq)
  then show "False"
    by auto
qed
...
export_code
  modusponens gen axiom_addimp axiom_distribimp axiom_doubleneg axiom_allimp axiom_impall
  axiom_existseq axiom_eqrefl axiom_predcong axiom_iffimp1 axiom_iffimp2
  axiom_impiff axiom_true axiom_not axiom_and axiom_or axiom_exists concl
in SML module_name Proven
...
ML_val \<open> (* Pelletier p34 / page 178 Andrews's challenge *)
...
ML_val \<open> (* gilmore_2 has a counterexample *)
