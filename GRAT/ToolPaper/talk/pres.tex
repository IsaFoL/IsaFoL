...
\begin{frame}{Enriched Certificates}
  Crucial idea 
    \begin{itemize}
     \item Unverified \emph{generator} records unit/conflict clauses
     \item Verified \emph{checker} replays BCP
     \item \emph{Finding} unit clause replaced by \emph{checking} unit clause
    \end{itemize}
  \pause  
  
  History
    \begin{itemize}
     \item Cruz-Filipe et al.~[TACAS 2017] for DRUP
     \item P.~L. [CADE 2017] extended to DRAT
     \item independently: Cruz-Filipe et al.~[CADE 2017] extended to DRAT
