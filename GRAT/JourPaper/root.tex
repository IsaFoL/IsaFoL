...
Finally, to obtain our verified sat and unsat checker \emph{gratchk}, Isabelle/HOL's code generator is used to extract Standard ML code for \isai{verify_(un)sat_impl}. 
...
\end{figure}
  ...
  the average speedup with eight threads is $2.1$, the average speedup of the backwards checking phase of gratgen, which is the only parallelized part, is $3.3$.
