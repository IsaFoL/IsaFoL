/*
  Efficient checker for GRIT+RAT unsat certificates.
...
inline bool State::rd_proof_item() {
  ...
  switch (DB.fetch_proof_item_type()) {
    case Store::proof_item_type::LEMMA: rd_lemma(); rd_induced_units(); return false;
    case Store::proof_item_type::DELETION: rd_del(); return false;
    case Store::proof_item_type::CONFLICT: rd_conflict(); return true;
  }
