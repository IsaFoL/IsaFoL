...
where
  \<open>already_propagated_unit_cls_heur' = (\<lambda>unbdd S.
     RETURN S)\<close>
...
sepref_definition init_state_wl_D'_code
  ...
  unfolding init_state_wl_D'_alt_def PR_CONST_def init_trail_D_fast_def[symmetric]  Suc_eq_plus1_left
    ...
    (* cach_refinement_l_assn_def  conflict_option_rel_assn_def
     * lookup_clause_rel_assn_def lcount_assn_def 
     * empty_mark_struct_def[symmetric] isasat_init_assn_def *)
...
thm get_conflict_wl_is_None_fast_code_def
