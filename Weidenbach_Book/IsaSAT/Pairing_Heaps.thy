...
apply (simp add: VSIDS_remove_key_children_alt_def filter_empty_conv)
        apply (smt (verit, ccfv_threshold)   in_hd_or_tl_conv node_in_mset_nodes option.map(2) the_default.simps(1))
