...
locale twl_state\<^sub>W_clss =
  abs_state\<^sub>W
    ...
    restart_state
    +
  raw_clss_with_update get_lit mset_cls get_cls mset_clss twl_cls clss_update
  ...
  assumes
    ...
    update_clause:
      "raw_clauses (update_clause S i E) = (raw_clauses S) (i := E)"
