...
(fn xb =>
  (fn () =>
    (plus_nat bia one_nat,
      (xb, (a1a, (a1b, (a1c, (a1d, (a1e, (bitXOR_nat x_f one_nat :: a1f,
   a2f)))))))))))
                             | SOME x_k =>
                               (fn f_ => fn () => f_
                                 ((nth_raa heap_nat a1a x_a x_k) ()) ())
                                 (fn x_l =>
                                   (fn f_ => fn () => f_
                                     ((swap_aa (default_nat, heap_nat) a1a x_a
x_c x_k)
                                     ()) ())
                                     (fn x_n =>
                                       (fn f_ => fn () => f_
 ((delete_index_and_swap_aa heap_nat a2f ai bia) ()) ())
 (fn x_p =>
