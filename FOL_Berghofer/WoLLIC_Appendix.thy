...
theory WoLLIC_Appendix imports WoLLIC_Sequent begin
...
lemma s1 [simp]: \<open>new_term c t = WoLLIC_FOL.new_term c t\<close> \<open>new_list c l = WoLLIC_FOL.new_list c l\<close>
  by (induct t and l rule: new_term_new_list.induct) simp_all

lemma s2 [simp]: \<open>new c p = WoLLIC_FOL.new c p\<close>
  by (induct p) simp_all

lemma s3 [simp]: \<open>news c x = WoLLIC_FOL.news c x\<close>
